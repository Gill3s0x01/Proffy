...
<p align="center">	
  ...
  <img alt="Repository size" src="https://img.shields.io/github/repo-size/Gilles30/proffy?color=774DD6">

  <a aria-label="Completed" href="https://nextlevelweek.com/episodios/omnistack/edicao/2">
    <img src="https://img.shields.io/badge/Proffy-NLW 2.0-8257E5?logo=data:image/png;base64,"></img>
  </a>
  <a href="https://github.com/Gilles30/proffy/commits/master">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/Gilles30/proffy?color=774DD6">
  </a> 
  <img alt="License" src="https://img.shields.io/badge/license-MIT-8257E5">
  <a href="https://github.com/Gilles30/proffy/stargazers">
    <img alt="Stargazers" src="https://img.shields.io/github/stars/Gilles30/proffy?color=8257E5&logo=github">
  </a>
</p>
...
<div align="center">
  <sub>The NLW #2 project. Built with ❤︎ by
    ...
    <a href="https://github.com/Gilles30/Proffy/">
      contributors
    </a>
  </sub>
</div>
...
👉  demo: https://www.youtube.com/watch?v=ptABXX-Amm4
...
```bash
# Clone Repository
$ git clone https://github.com/Gilles30/Proffy.git
```
### 📦 Run API
...
Feel free to **file a new issue** with a respective title and description on the the [Proffy](https://github.com/Gilles30/Proffy/issues) repository. If you already found a solution to your problem, **i would love to review your pull request**!
